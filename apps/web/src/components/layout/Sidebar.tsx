import { Activity, Users, Settings, Cpu, Grid, Shield, Video, FileText, TrendingUp, Scan, Bot, Network, Eye, ReceiptText, Split, HeartHandshake, Workflow, Gauge } from 'lucide-react';
  ...
  return (
    <aside className="w-20 lg:w-64 glass-panel border-r-white/10 flex flex-col items-center lg:items-start py-8 z-10 rounded-r-3xl my-4 ml-4">
      ...
      <div className="mt-auto px-4 w-full">
        ...
        <a href="/risk" className="flex items-center gap-3 px-4 py-3 text-zinc-400 hover:text-white hover:bg-white/5 rounded-xl transition-all group">
          <Gauge className="h-5 w-5 group-hover:text-neon-400 transition-colors" />
          <span className="hidden lg:block font-medium">Risk Stratification</span>
        </a>
